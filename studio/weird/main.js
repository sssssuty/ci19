...
function preload(){
    myFont = loadFont('assests/type/mabry.ttf');
    myFont2 = loadFont('assests/type/NinjaStrike.otf');
    myFont5 = loadFont('assests/type/Italianno.otf');
    myFont3 = loadFont('assests/type/PermanentMarker.otf');
    myFont6 = loadFont('assests/type/cao.ttf');
    myFont4 = loadFont('assests/type/orbitron.otf');
    myFont7 = loadFont('assests/type/Grand Hotel.otf');
}
